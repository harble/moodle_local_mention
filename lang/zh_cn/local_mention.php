...
$string['datareviewsubject'] = 'Database待审核提醒：{$a} 提交了新内容';
$string['datareviewcontent'] = '用户 {$a->submitter} 提交了待审核的Database内容，请查看：{$a->url}';
$string['datareviewremindersubject'] = 'Database待审核第{$a}次提醒';
$string['datareviewremindercontent'] = '【第{$a->seq}次提醒】用户 {$a->submitter} 提交的Database内容已待审核 {$a->elapseddays} 天，请尽快处理：{$a->url}';